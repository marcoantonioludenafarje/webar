...
| A4 | [Interaction](./labs/mindar-aframe/lab-04-interaction/) | ¿Puede un objeto AR comportarse como un elemento de UI interactivo (tap, feedback)? | Latencia de interacción, tasa de fallos de raycasting | Implementado, pendiente de prueba física |
...
Los labs A1 a A4 están **implementados y desplegados**, no validados:
...
avance del roadmap (PLAYBOOK §23) — con el límite de §23.5. A3 y A4 se
implementaron bajo ese límite: ninguno asume resultados del anterior. A3
mide la estabilidad del tracking con un personaje encima en vez de darla
por sentada, y A4 fija el modelo chico para no confundir las cifras de
interacción con la carga de render.

**A5 sí está detrás del límite**: integra A3 y A4 asumiendo que ambos
funcionan, así que conviene validar antes de construirlo.
